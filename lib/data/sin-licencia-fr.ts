...
export const pillarFr = {
  ...
  intro: {
    ...
    text: 'Devenez capitaine le temps d\'une journée sans avoir besoin de titulaire nautique. Chez Experience Boat, vous pouvez louer un bateau sans permis à Roses et partir directement depuis les canaux de Santa Margarita vers la baie de Roses et le Parc Naturel du Cap de Creus. Aucune expérience préalable requise — nos embarcations sont conçues pour que tout le monde puisse les piloter dès la première minute.',
  },
  boatGrid: {
    sectionLabel: 'Flotte sans permis',
    h2: 'Nos bateaux sans permis à Roses',
    desc: 'Nous disposons de trois embarcations sans permis, toutes adaptées à des groupes de différentes tailles. Départ depuis la Marina de Santa Margarita. Réservation à la demi-journée ou à la journée complète.',
  ...
  destinations: {
    ...
    intro: 'Plus que vous ne l\'imaginez. Partir depuis les canaux de Santa Margarita est déjà une expérience en soi : maisons face à l\'eau et une ambiance unique que l\'on ne découvre que depuis la mer. La baie de Roses et le Cap de Creus sont à quelques minutes. Vous choisissez la route, le rythme et les arrêts — sans horaires fixes ni groupes avec qui partager l\'embarcation.',
    listIntro: 'Voici quelques coins que vous pouvez explorer à votre rythme :',
    privateTitle: 'Tout privatif — seulement votre groupe à bord',
    privateDesc1: 'C\'est peut-être la différence la plus importante. Quand vous louez un bateau sans permis chez Experience Boat, l\'embarcation est exclusivement pour votre groupe. Sans inconnus, sans horaires partagés, sans devoir adapter l\'itinéraire à une autre famille.',
  ...
  faq: {
    ...
    faqs: [
      { question: 'Faut-il un permis nautique pour louer un bateau à Roses ?', answer: 'Non. En Espagne, vous pouvez louer des embarcations jusqu\'à 5 mètres de longueur et des moteurs jusqu\'à 15 CV sans aucune titulaire nautique. Tous nos bateaux sans permis respectent cette réglementation.' },
      { question: 'Puis-je partir seul ou dois-je être accompagné ?', answer: 'Vous pouvez partir seul ou en groupe. Nos embarcations sans permis accueillent entre 4 et 6 personnes selon le modèle.' },
      ...
      { question: 'Peut-on se baigner dans les criques ?', answer: 'Oui. Toutes nos embarcations sont équipées d\'une échelle de bain. Vous pouvez vous arrêter dans les criques de votre choix pendant votre itinéraire.' },
...
export const couplesFr = {
  ...
  intro: {
    h2: 'Le plan le plus exclusif de la Costa Brava',
  ...
  porQue: {
    sectionLabel: 'Mieux que tout plan à terre',
    h2: 'Pourquoi un bateau est le plan parfait pour un couple à Roses',
    features: [
      ...
      { title: 'Sans expérience préalable', desc: 'Vous n\'avez besoin d\'aucune expérience nautique ni de permis. En moins de 15 minutes depuis que vous quittez les canaux de Santa Margarita, vous naviguez seuls avec une totale aisance.' },
    ],
  },
  canales: {
  ...
  faq: {
    ...
    faqs: [
      ...
      { question: 'Pouvons-nous apporter notre propre nourriture et boissons à bord ?', answer: 'Oui, sans aucun problème. Une glacière avec vos préférés et un arrêt dans une crique tranquille pour déjeuner est l\'un des plans les plus appréciés des couples qui partent avec nous.' },
