...
export const pillarCa = {
  ...
  practicalInfo: {
    ...
    items: [
      ...
      { question: 'Quins són els preus?', prices: [{ label: 'Mig dia (4 hores)', value: 'des de 70 €' }, { label: 'Dia complet (8 hores)', value: 'des de 120 €' }], note: 'Els preus varien segons l\'embarcació i la temporada. Consulteu disponibilitat per a la vostra data concreta.' },
  ...
  stickyCTA: {
    ...
    popupDesc: 'Des de 70 € / mig dia. Sortida des de Santa Margarida.',
...
export const canauxCa = {
  ...
  infoPractica: {
    ...
    items: [
      ...
      { question: 'Preu del lloguer', prices: [{ label: 'Mig dia (4 hores)', value: 'des de 70 €' }, { label: 'Dia complet (8 hores)', value: 'des de 120 €' }] },
    ],
  },
};
