...
export function MobileDrawer({ data }: { data: any }) {
  ...
  const expData = data.experiencias[lang as 'es' | 'fr' | 'en'];
        ...
        <nav className="flex-1 overflow-y-auto py-2">
          <ul className="flex flex-col">
            ...
            <li className="border-b border-gray-100">
              <div className="flex items-stretch w-full">
                ...
                <button
                  ...
                  aria-label={isBarcosOpen ? 'Contraer submenú Barcos' : 'Expandir submenú Barcos'}
                >
                    ...
                    {data.barcosConLicencia.map((barco: any) => (
                      <li key={barco.url}>
                        ...
                        >
                          ...
                          <span className="text-[12px] text-[var(--megamenu-text-muted)]">desde {barco.price} €</span>
                        </Link>
                      </li>
                    ))}
                  </ul>
            ...
            <li className="border-b border-gray-100">
              ...
              >
                <div className="px-5 space-y-4">
                  ...
                  <ul className="space-y-4">
                    {expData.items.map((item: { name: string; url: string }) => (
                      <li key={item.url}>
                        <Link
                          href={item.url}
                          onClick={closeMenu}
            ...
            {data.links.map((link: any) => (
              <li key={link.url} className="border-b border-gray-100">
                <Link 
                  href={link.url}
                  onClick={closeMenu}
