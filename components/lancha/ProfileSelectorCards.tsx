...
const t: Record<Lang, Record<string, any>> = {
  ...
  fr: {
    ...
    card1Title: 'Bateaux avec permis',
    card1Desc: 'Vous décidez l\'itinéraire, le rythme et les arrêts. Liberté totale sur la baie de Roses et le Cap de Creus. Sans skipper, sans intermédiaires.',
    card1Button: 'Voir les bateaux avec permis',
    card1Link: '/fr/location-bateau-avec-permis-roses',
    card2Label: 'Je préfère un skipper',
    card2Title: 'Excursions privées avec skipper',
    ...
    card2Link: '/fr/experiences-bateau-roses',
  },
  ca: {
