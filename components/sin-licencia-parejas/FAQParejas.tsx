...
import { faqParejas as defaultFaqs } from './faq-data-parejas';
...
const defaults: Required<Omit<FAQParejasT, 'faqs'>> = {
  sectionLabel: 'Resuelve tus dudas',
  h2: 'Preguntas frecuentes',
  desc: 'Dudas habituales sobre el alquiler de barcos para parejas.',
  waPrompt: '¿Tienes alguna otra pregunta o quieres organizar algo especial?',
  waLink: 'Pregúntanos por WhatsApp →',
  waMessage: 'Hola%2C%20tengo%20una%20pregunta%20sobre%20el%20alquiler%20de%20barco%20sin%20licencia%20para%20parejas',
};
...
export default function FAQParejas({ t }: { t?: FAQParejasT }) {
