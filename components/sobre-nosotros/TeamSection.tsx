...
const t: Record<Lang, {
  ...
  ca: {
    ...
    cta_p: 'Teniu dubtes sobre quin vaixell o servei s\'adapta millor al vostre grup? Escriviu-nos i us assessorem sense compromís.',
    ...
    f4d: 'Operem des de la primavera fins a la tardor, que és quan el mar aquí està en el seu millor moment.',
  },
  es: {
    tag: 'Nuestro equipo',
    ...
    f4d: 'Operamos de primavera a otoño, que es cuando el mar aquí está en su mejor momento.',
  },
  fr: {
    tag: 'Notre équipe',
    ...
    f1d: "Tout le personnel embarqué est titulaire des brevets homologués par la Direction générale espagnole de la marine marchande.",
