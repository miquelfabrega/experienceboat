    ...
    <section id="boats" className="py-20 bg-white scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-4">
          <span className="text-sky-600 font-semibold text-sm uppercase tracking-widest">Fleet</span>
        </div>
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 text-center mb-4">
          Choose your boat for the Bay of Roses
        </h2>
        <p className="text-gray-500 text-center max-w-2xl mx-auto mb-12 text-lg">
          We have boats for different group sizes. All depart from the Marina de Santa Margarita
          and are perfect for navigating the Bay of Roses.
        </p>
          ...
          {boats.map((boat) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                <Image
                  src={boat.image}
                  alt={`${boat.model} for rental in the Bay of Roses`}
                  fill
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <a
                  href={`https://wa.me/34623995700?text=Hello%2C%20I%27m%20interested%20in%20the%20${encodeURIComponent(boat.model)}%20for%20the%20Bay%20of%20Roses`}
                  target="_blank"
