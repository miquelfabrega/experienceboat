...
const t: Record<Lang, string> = {
  ca: 'Hi ha dues maneres de gaudir del mar a Roses: llogar una embarcació i sortir pel vostre compte, o deixar que algú que coneix cada cala us hi porti. A Experience Boat oferim totes dues — i aquesta és la segona. Les nostres experiències en vaixell són sortides privades on el patró s\'encarrega de tot: la navegació, la ruta i els imprevistos. Vosaltres només us heu de preocupar de gaudir. Des dels canals de Santa Margarida fins a les cales més verges del Cap de Creus, amb el grup que vulgueu i al ritme que preferiu.',
