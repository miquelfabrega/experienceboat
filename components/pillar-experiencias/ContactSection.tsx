...
const translations = {
  es: {
    ...
    phoneLabel: 'Teléfono',
    emailLabel: 'Email',
    whatsappText: 'Hola%2C%20me%20interesa%20reservar%20una%20experiencia%20en%20barco%20en%20Roses',
  ...
  en: {
    ...
    phoneLabel: 'Phone',
    emailLabel: 'Email',
    whatsappText: 'Hi%2C%20I%27d%20like%20to%20book%20a%20boat%20experience%20in%20Roses',
  ...
  fr: {
    ...
    emailLabel: 'E-mail',
    whatsappText: 'Bonjour%2C%20je%20souhaite%20r%C3%A9server%20une%20sortie%20en%20bateau%20%C3%A0%20Roses',
  ...
  ca: {
    ...
    phoneLabel: 'Telèfon',
    emailLabel: 'Correu',
    whatsappText: 'Hola%2C%20voldria%20reservar%20una%20experi%C3%A8ncia%20en%20vaixell%20a%20Roses',
    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          {/* Contact info */}
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm flex flex-col justify-between anim-fade-right">
            <div>
