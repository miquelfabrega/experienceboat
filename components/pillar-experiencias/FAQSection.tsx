...
const t: Record<Lang, Record<string, string>> = {
  ...
  es: {
    ...
    description: 'Todo lo que necesitas saber antes de reservar una experiencia con patrón en Roses.',
  ...
  fr: {
    ...
    description: 'Tout ce que vous devez savoir avant de réserver une expérience avec skipper à Roses.',
  ...
  en: {
    ...
    description: 'Everything you need to know before booking a skippered experience in Roses.',
