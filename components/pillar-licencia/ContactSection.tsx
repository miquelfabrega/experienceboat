    ...
    <section className="py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          {/* Contact info */}
          <div
            className="bg-slate-50 rounded-3xl p-8 border border-slate-100 flex flex-col justify-between anim-fade-right"
          >
            <div>
            ...
            <a
              href="https://wa.me/34623995700?text=Hola%2C%20me%20interesa%20alquilar%20un%20barco%20con%20licencia%20en%20Roses"
              target="_blank"
