...
const t: Record<Lang, Record<string, string>> = {
  es: {
    ...
    description: 'Desde 195 € / medio día. Salida desde Santa Margarita.',
  ...
  fr: {
    ...
    description: 'À partir de 195 € / demi-journée. Départ depuis Santa Margarita.',
  ...
  en: {
    ...
    description: 'From 195 € / half-day. Departing from Santa Margarita.',
