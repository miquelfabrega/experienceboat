    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 text-center mb-4">
          Dónde encontrarnos — en la entrada de los canales
        </h2>
        <p className="text-gray-500 text-center mb-12 text-lg">
          Nuestro punto de encuentro está en la entrada de la Marina de Santa Margarita, justo al inicio de los
          canales. Fácil de encontrar y con aparcamiento cercano. Desde Roses centro, menos de 5 minutos en coche.
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            <iframe
              ...
              title="Ubicación Experience Boat — Marina de Santa Margarita, entrada de los canales, Roses"
              aria-label="Mapa de ubicación de Experience Boat en la entrada de los canales de Santa Margarita, Roses"
            />
          </div>
        </div>
      </div>
