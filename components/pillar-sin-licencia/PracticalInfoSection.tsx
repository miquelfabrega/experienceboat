...
const defaultItems = [
  { icon: FileCheck, question: '¿Necesito experiencia para llevar el barco?', answer: 'No. Nuestros barcos sin licencia tienen motores de baja potencia homologados para navegación sin titulación. Antes de salir, Salvador o el equipo te explican el funcionamiento en unos minutos. La mayoría de clientes salen solos sin ningún problema desde el primer día.' },
