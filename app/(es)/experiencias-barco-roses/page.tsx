  ...
  const schema = {
    ...
    '@id': 'https://experienceboat.es/#local-business',
      ...
      },
      {
        ...
        item: {
          '@type': 'TouristTrip',
          '@id': 'https://experienceboat.es/experiencias-barco-roses/cap-de-creus-calas',
          name: 'Excursión al Cap de Creus en barco — Baño en 3 calas',
          url: 'https://experienceboat.es/experiencias-barco-roses/cap-de-creus-calas',
      ...
      },
      {
        ...
        item: {
          '@type': 'TouristTrip',
          '@id': 'https://experienceboat.es/experiencias-barco-roses/cadaques',
          name: 'Excursión a Cadaqués en barco desde Roses',
          url: 'https://experienceboat.es/experiencias-barco-roses/cadaques',
      ...
      },
      {
        ...
        item: {
          '@type': 'TouristTrip',
          '@id': 'https://experienceboat.es/experiencias-barco-roses/cuevas-snorkel',
          name: 'Cuevas & Snorkel en barco — Costa Brava desde Roses',
          url: 'https://experienceboat.es/experiencias-barco-roses/cuevas-snorkel',
