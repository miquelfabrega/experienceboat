...
const t = DESTINOS_COPY.calaMontjoi.es!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('calaMontjoi', 'es'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/cala-montjoi',
...
export default function Page() {
  return <GuiaDestino lang="es" destino="calaMontjoi" />;
}
