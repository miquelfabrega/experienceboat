...
const t = DESTINOS_COPY.calaMurtra.en!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('calaMurtra', 'en'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/en/cala-murtra',
...
export default function Page() {
  return <GuiaDestino lang="en" destino="calaMurtra" />;
}
