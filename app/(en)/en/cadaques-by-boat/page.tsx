...
const t = DESTINOS_COPY.cadaquesBarco.en!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('cadaquesBarco', 'en'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/en/cadaques-by-boat',
...
export default function Page() {
  return <GuiaDestino lang="en" destino="cadaquesBarco" />;
}
