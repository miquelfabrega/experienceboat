...
const t = DESTINOS_COPY.cadaquesBarco.ca!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('cadaquesBarco', 'ca'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/ca/cadaques-en-vaixell',
...
export default function Page() {
  return <GuiaDestino lang="ca" destino="cadaquesBarco" />;
}
