...
const t = DESTINOS_COPY.calaMurtra.ca!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('calaMurtra', 'ca'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/ca/cala-murtra',
...
export default function Page() {
  return <GuiaDestino lang="ca" destino="calaMurtra" />;
}
