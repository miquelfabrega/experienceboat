...
const ui: Record<Lang, {
  ...
  en: {
    ...
    siloCta1: 'See no-licence boats', siloHref1: '/en/boat-rental-no-licence-roses/',
...
const boatsData = [
  { id: 'jeanneau-595-reineta',  name: 'Jeanneau 595 Reineta', cat: 'with',    badge: { es: '⭐ Más reservado',             fr: '⭐ Le plus réservé',              en: '⭐ Most booked'              }, price: { es: 'Desde 195 € · ½ día',      fr: 'À partir de 195 € · ½ journée', en: 'From €195 · ½ day'      }, href: '/jeanneau-595-reineta/', img: '/images/boats/jeanneau-595.jpg'     },
  { id: 'zodiac-medline-i',      name: 'Zodiac Medline I',     cat: 'with',    badge: { es: '🔥 Mejor relación calidad/precio', fr: '🔥 Meilleur rapport qualité/prix', en: '🔥 Best value for money'  }, price: { es: 'Desde 181 € · ½ día',      fr: 'À partir de 181 € · ½ journée', en: 'From €181 · ½ day'      }, href: '/zodiac-medline-i/',     img: '/images/boats/zodiac-medline-1.jpg' },
  { id: 'zodiac-medline-ii',     name: 'Zodiac Medline II',    cat: 'with',    badge: null,                                                                                                              price: { es: 'Desde 235 € · ½ día',      fr: 'À partir de 235 € · ½ journée', en: 'From €235 · ½ day'      }, href: '/zodiac-medline-ii/',    img: '/images/boats/zodiac-medline-2.jpg' },
  { id: 'spirit-of-the-sea',     name: 'Spirit of the Sea',    cat: 'with',    badge: { es: '−5% descuento aplicado',           fr: '−5 % de réduction appliquée',    en: '−5% discount applied'    }, price: { es: 'Desde 260 € · ½ día',      fr: 'À partir de 260 € · ½ journée', en: 'From €260 · ½ day'      }, href: '/spirit-of-the-sea/',   img: '/images/boats/spirit.jpg'           },
  { id: 'costa-brava-boat',      name: 'Costa Brava Boat',     cat: 'with',    badge: null,                                                                                                              price: { es: 'Desde 320 € · ½ día',      fr: 'À partir de 320 € · ½ journée', en: 'From €320 · ½ day'      }, href: '/costa-brava-boat/',    img: '/images/boats/costa-brava.jpg'      },
  { id: 'tio-marc-mano',         name: 'Tío Marc Mano',        cat: 'with',    badge: { es: '−10% descuento aplicado',          fr: '−10 % de réduction appliquée',   en: '−10% discount applied'   }, price: { es: 'Desde 245 € · ½ día',      fr: 'À partir de 245 € · ½ journée', en: 'From €245 · ½ day'      }, href: '/tio-marc-mano/',       img: '/images/boats/tio-marc.jpg'         },
  { id: 'remus-450',             name: 'Remus 450',             cat: 'no',      badge: { es: '⚡ Ideal canales Santa Margarita', fr: '⚡ Idéal canaux Santa Margarita', en: '⚡ Perfect for Santa Margarita canals' }, price: { es: 'Desde 90 € · 1 hora', fr: 'À partir de 90 € · 1 heure', en: 'From €90 · 1 hour' }, href: '/remus-450/',           img: '/images/boats/remus.jpg'            },
  { id: 'dream-point-boat',      name: 'Dream Point Boat',      cat: 'no',      badge: null,                                                                                                              price: { es: 'Desde 71 € · 1 hora',      fr: 'À partir de 71 € · 1 heure',    en: 'From €71 · 1 hour'      }, href: '/dream-point-boat/',    img: '/images/boats/dream-point.jpg'      },
  { id: 'sessa-marine-c35',      name: 'Sessa Marine C35',      cat: 'premium', badge: { es: '💎 Experiencia VIP',               fr: '💎 Expérience VIP',               en: '💎 VIP Experience'        }, price: { es: 'Desde 618 € · 1 día',      fr: 'À partir de 618 € · 1 journée', en: 'From €618 · 1 day'      }, href: '/sessa-marine-c35/',    img: '/images/boats/sessa.jpg'            },
];
