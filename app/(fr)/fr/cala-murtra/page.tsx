...
const t = DESTINOS_COPY.calaMurtra.fr!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('calaMurtra', 'fr'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/fr/cala-murtra',
...
export default function Page() {
  return <GuiaDestino lang="fr" destino="calaMurtra" />;
}
