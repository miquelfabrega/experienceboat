...
const t = DESTINOS_COPY.queVerRoses.fr!;

export const metadata: Metadata = {
  title: t.metaTitle,
  description: t.metaDescription,
  alternates: buildAlternates('queVerRoses', 'fr'),
  openGraph: {
    title: t.metaTitle,
    description: t.metaDescription,
    url: 'https://www.experienceboat.es/fr/que-faire-a-rosas',
...
export default function Page() {
  return <GuiaDestino lang="fr" destino="queVerRoses" />;
}
