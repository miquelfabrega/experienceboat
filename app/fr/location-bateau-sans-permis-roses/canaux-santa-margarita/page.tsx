...
export const metadata: Metadata = {
  title: 'Bateau sans permis dans les canaux de Santa Margarita — Roses',
  description:
    'Naviguez dans les canaux de Santa Margarita sans permis depuis Roses. Eaux calmes, maisons face à l\'eau et la Costa Brava la plus authentique. Réservation en ligne.',
  alternates: {
  ...
  openGraph: {
    title: 'Bateau sans permis dans les canaux de Santa Margarita — Roses',
    description:
      'Naviguez dans les canaux de Santa Margarita sans permis depuis Roses. Eaux calmes, maisons face à l\'eau et la Costa Brava la plus authentique.',
