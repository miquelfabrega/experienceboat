...
title: 'Barco sin licencia en Roses para parejas',
  description:
    'El plan más exclusivo para parejas en la Costa Brava. Alquila un barco sin licencia, recorre los canales de Santa Margarita y descubre calas inaccesibles a vuestro ritmo.',
  alternates: {
